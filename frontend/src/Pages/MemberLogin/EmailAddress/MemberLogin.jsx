    ...
    <div>
      <div className="flex justify-center items-center min-h-screen mt-10 mb-10">
        <div className="sm:h-[725px] h-auto w-[85%] flex flex-col justify-center items-center border-2 border-primary rounded-md shadow-xl">
          ...
          <form className="w-full flex justify-center items-center h-[45%] mt-6 sm:mt-0">
            {/* username */}
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <Button
                    variant="contained"
                    // type="submit"
                    onClick={() => navigate("/gtin-management")}
                  ...
                  <div className="flex justify-end items-end gap-6 text-secondary text-lg font-sans">
