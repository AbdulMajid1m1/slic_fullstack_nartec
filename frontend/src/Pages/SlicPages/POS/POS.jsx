...
const POS = () => {
  ...
  const totalWithVat = 1000.00; // Example total with VAT
  ...
  const generateZatcaTLV = () => {
    ...
    return sellerNameTLV + vatRegistrationNumberTLV + invoiceDateTLV + totalWithVatTLV + vatTotalTLV;
  };
  ...
  const handlePrintSalesInvoice = () => {
    ...
    printWindow.onload = () => {
      ...
      const decodedString = atob("MDEyNVNhdWRpIExlYXRoZXIgSW5kdXN0cmllcyBDb21wYW55IEx0ZC4wMjBmMzAwNDU2NDE2NTAwMDAzMDMxODIwMjQtMDgtMTdUMDk6NDk6MjguNzc5WjA0MDcxMDAwLjAwMDUwNjE1MC4wMA==");
