...
import { Edit2, Trash2, Plus, Printer, RefreshCw, Loader2 } from "lucide-react";
      ...
      <div className="px-6 py-4 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
          ...
          {selectedRows.length > 0 && (
            <button 
              onClick={handlePrint}
              className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-md text-sm font-medium flex items-center justify-center gap-2 transition-colors"
            >
